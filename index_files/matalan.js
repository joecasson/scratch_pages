...
__sco.onChangeAdded = __sco.onChangeAdded || false;
...
__sco.config = {
    ...
    'startdate': 1386633600000,           // In milliseconds, the date the script went live

    'guid': '72369F7C-6B6B-44FC-A3E4-3A98F50B125A', // V2 guid
    'v1guid': '72369F7C-6B6B-44FC-A3E4-3A98F50B125A', // V1 guid, the api key for the client

    'triggers': ['exit', 'timeout'], // Set the triggers to use, use either load or exit and timeout together

    'status1': ["checkout", function () {

        return (_scs("#minicart-items") != null && _scs('body button.add-to-bag') != null);
    ...
    'status2': [function () {
        ...
        for (var key = 0; key < __sco.additionalOSRPages.length; key++) {
            if (__sco.contains(document.location.href.toLowerCase()), __sco.additionalOSRPages[key].toLowerCase()) {
                return true;
            }
        }

        for (var key = 0; key < __sco.schoolPromoPages.length; key++) {
            if (__sco.contains(document.location.href.toLowerCase()), __sco.schoolPromoPages[key].toLowerCase()) {
                return true;
            }
        }

        for (var key = 0; key < __sco.lingeriePromoPages.length; key++) {
            if (__sco.contains(document.location.href.toLowerCase()), __sco.lingeriePromoPages[key].toLowerCase()) {
                return true;
            }
        }
        return false;
    ...
    'onchange': {
        'email': ['#LoginEmail', '#NewEmail', '#Email', '#ConfirmEmail', '#email'],
        'first': ['#FirstName', '#Billing_Address_FirstName'],
        'last': ['#LastName', '#Billing_Address_LastName'],
        'telephone': ['#Phone', '#Billing_Address_PhoneNumber'],
        'mobile': [],
        'salutation': [],
        'optout': []
    },
...
__sco.basketType = 'basket';

__sco.additionalOSRPages = [
     "/homeware/offers/sale?page=1&size=36&cols=3&sort=&id=/homeware/offers/sale&priceRange[min]=1&priceRange[max]=17",
    "/womens/offers/sale?page=1&size=36&cols=3&sort=&id=/womens/offers/sale&priceRange[min]=0.75&priceRange[max]=10",
    "/events/sale?page=1&size=120&cols=4&sort=&id=/events/sale&priceRange[min]=0.5&priceRange[max]=18",
    "/events/sale?page=1&size=36&cols=3&sort=&id=/events/sale&priceRange[min]=0.5&priceRange[max]=18",
    "/events/sale?page=4&size=36&cols=4&sort=&id=/events/sale&priceRange[min]=0.5&priceRange[max]=18",
    "/events/sale?page=2&size=36&cols=4&sort=&id=/events/sale&priceRange[min]=0.5&priceRange[max]=18",
    "/events/sale?page=3&size=36&cols=4&sort=&id=/events/sale&priceRange[min]=0.5&priceRange[max]=18",
    "/events/sale?page=1&size=36&cols=4&sort=&id=/events/sale&filters[Department]=womens",
    "/sale?page=1&size=36&cols=3&sort=&id=/sale&priceRange[min]=0.5&priceRange[max]=18",
    "/womens/offers/sale?page=1&cols=4&size=36&id=/womens/offers/sale&sort=price.asc",
    "/events/holiday-shop/womens-holiday-shop?page=sale-landing-womens-holiday",
    "/product/detail/Womens/Offers/Sale/Sale-Trousers-and-Skirts/S2592027",
    "/product/detail/Womens/Offers/Sale/Sale-Trousers-and-Skirts/S2583414",
    "/womens/offers/sale/s2517530/snaffle-trousers-in-black-27-inch-leg",
    "/events/sale?page=1&cols=4&size=36&id=/events/sale&sort=price.asc",
    "/events/sale?page=3&cols=4&size=36&id=/events/sale",
    "/events/sale?page=4&cols=4&size=36&id=/events/sale",
    "/events/sale?page=2&cols=4&size=36&id=/events/sale",
    "/womens/offers/sale/s2594668/3-4-sleeve-jersey-top",
    "/kids-clothing/girls/offers/sale?page=sale-c1",
    "/kids-clothing/boys/offers/sale?page=sale-c2",
    "/womens/footwear?page=sale-landing-footwear",
    "/homeware/offers/sale?page=sale-d1",
    "/events/footwear-sale?page=sale-d2",
    "/kids-clothing/girls/offers/sale",
    "/womens/offers/sale?page=sale-b1",
    "/Womens/Offers/Sale/Sale-Dresses",
    "/womens/offers/sale/sale-dresses",
    "/kids-clothing/boys/offers/sale",
    "/womens/offers/sale?page=sale-a",
    "/mens/offers/sale?page=sale-b2",
    "/events/sale/s2518412/",
    "/events/sale/s2513820/",
    "/events/sale/s2513818/",
    "/events/sale/s2526014/",
    "/homeware/offers/sale",
    "/events/footwear-sale",
    "/womens/offers/sale",
    "/mens/offers/sale",
    "/events/sale",
    "/shop-sale",
...
__sco.suitcasePromo = [
                        "/homeware/travel-essentials/travel-essentials",
                        "/homeware/travel-essentials/suitcases-and-travel"
];

__sco.lingeriePromoPages = [
                          "/womens/shop-by-category/lingerie/knickers",
                          "/womens/shop-by-category/socks-and-tights",
                          "/womens/shop-by-category/shapewear",
                          "/womens/shop-by-category/lingerie",
                          "/womens/collections/lingerie"];


__sco.schoolPromoPages = ["/kids-clothing/girls/girls-highlights/back-to-school/afterschool-and-sportswear",
"/kids-clothing/girls/girls-highlights/back-to-school/underwear-socks-andtights",
"/kids-clothing/boys/shop-by-category/back-to-school/afterschool-and-sportswear",
"/kids-clothing/boys/shop-by-category/back-to-school/school-underwear-andsocks",
"/kids-clothing/boys/shop-by-category/back-to-school/jumpers-and-sweatshirts",
"/kids-clothing/girls/girls-highlights/back-to-school/dresses-and-pinafores",
"/kids-clothing/girls/girls-highlights/back-to-school/dresses-and-pinafores",
"/kids-clothing/girls/girls-highlights/back-to-school/jumpers-and-cardigans",
"/kids-clothing/girls/girls-highlights/back-to-school/trousers-and-skirts",
"/kids-clothing/boys/shop-by-category/back-to-school/trousers-and-shorts",
"/kids-clothing/girls/girls-highlights/back-to-school/blouses-and-polos",
"/kids-clothing/girls/girls-highlights/back-to-school/coats-and-jackets",
"/kids-clothing/boys/shop-by-category/back-to-school/coats-and-jackets",
"/kids-clothing/girls/girls-highlights/back-to-school/school-footwear",
"/kids-clothing/boys/shop-by-category/back-to-school/shirts-and-polos",
"/kids-clothing/boys/shop-by-category/back-to-school/school-footwear",
"/kids-clothing/girls/girls-highlights/back-to-school/shop-all",
"/kids-clothing/boys/shop-by-category/back-to-school/shop-all",
"/homeware/nursery-and-kids-bedroom/lunch-bags-andstationery",
"/kids-clothing/schoolwear/school-easy-iron-shirts",
"/kids-clothing/schoolwear/5-star-rated-products",
"/discover/schoolwear/school-bags-and-backpacks",
"/discover/schoolwear/school-bags-and-backpacks",
"/discover/schoolwear/school-bags-and-backpacks",
"/kids-clothing/schoolwear/school-sportswear",
"/school-shop/uniform-features-and-benefits",
"/kids-clothing/schoolwear/adjustable-waist",
"/discover/schoolwear/underwear-and-socks",
"/kids-clothing/schoolwear/stain-resistant",
"/kids-clothing/schoolwear/smart-crease",
"/kids-clothing/schoolwear/multi-packs",
"/school-shop/footwear-measuring-guide",
"/kids-clothing/schoolwear/100--cotton",
"/kids-clothing/kidswear/school-coats",
"/discover/schoolwear/school-trousers",
"/school-shop/uniform-measuring-guide",
"/kids-clothing/schoolwear/secure-hem",
"/discover/schoolwear/school-jumpers",
"/discover/schoolwear/school-shirts",
"/discover/schoolwear/school-polos",
"/life-and-style/school-checklist",
"/events/childrens-schoolwear",
"/kids-clothing/shoes/leather",
"/kids-shoe-size-guide"];

__sco.getitemlink = function (item) {
    if (!!__sco.lastbasket && __sco.lastbasket.i.length > 0) {
        for (var j = 0; j < __sco.lastbasket.i.length; j++) {
            if (__sco.lastbasket.i[j].n == item) {
                return __sco.lastbasket.i[j].link;
            }
        }
    }
    return "";
...
__sco.scraper.statusone = function () {
    ...
    if (__sco.contains(__sco.loc, '/checkout') && _scs('#cart tr.item') && _scs('#shopping-bag-content') && !__sco.contains('checkout/paypal') && !__sco.contains('checkout/login')) {
        try {
            __scd.u = __scd.u + " MAIN";
            __scd.s.offerlabel = '';
            __scd.s.offervalue = '';
            __scd.s.offerlabel2 = '';
            __scd.s.offervalue2 = '';
            __scd.s.shippingvalue = '';
            __scd.s.shippingdiscount = '';
            __scd.s.shipping = '';
            __scd.s.shippingdiscountvalue = '';
            __scd.s.subtotal = '';

            var shippingValue = 0, shippingDiscount = 0, basketValue = 0;

            if (_scs('#cart-totals.promo')) {
                __scd.s.offerlabel = _scs('#cart-totals dt.promo', "0 offerlabel", ['text']);
                __scd.s.offervalue = _scs('#cart-totals dd.promo', "0 offervalue", ['text']);
                if (_scs('#cart-totals dd.promo:nth-child(1)')) {
                    if (_scs('#cart-totals dt.promo:nth-child(1)', "0 offerlabel 2 text", ['text']) != "Free Standard Delivery:") {
                        __scd.s.offerlabel2 = _scs('#cart-totals dt.promo:nth-child(1)', "0 offerlabel 2", ['text']);
                        __scd.s.offervalue2 = _scs('#cart-totals dd.promo:nth-child(1)', "0 offervalue 2", ['text']);
                    }
                }
            }
            if (_scs('#cart-totals dd.shipping')) {
                __scd.s.shippingvalue = _scs('#cart-totals dd.shipping:first', ' 0 shipping value', ['text']);
                shippingValue = parseFloat(_scs('#cart-totals dd.shipping:first', ' 0 shipping value', ['text', 'pricecurr']));
            }
            if (_scs('#cart-totals dd.shippingpromo')) {
                __scd.s.shippingdiscount = _scs('#cart-totals dt.shippingpromo:first', ' 0 shipping discount', ['text']);
                __scd.s.shippingdiscountvalue = _scs('#cart-totals dd.shippingpromo:first', ' 0 shipping discount value', ['text']);
                shippingDiscount = parseFloat(_scs('#cart-totals dd.shippingpromo:first', ' 0 shipping discount value', ['text', 'pricecurr']));
            }
            __scd.s.subtotal = _scs('#promo-entry td.price:first', ' 0 subtotal', ['text', 'pricecurr']);
            __scd.b.v = _scs('#promo-entry td.price:first', ' 0 basket value, no shipping', ['text', 'pricecurr']); //Set the total value


            basketValue = parseFloat(_scs('#cart-totals .total:last', 'overall total', ['text', 'pricecurr']));

            __scd.s['ot'] = (basketValue - (shippingValue + shippingDiscount)).toFixed(2);
            /*__scd.s['j.f.d'] = "";*/ // Example session field
        }
        catch (be2) {
        ...
        try {
            __sco.each(_scs('#cart tr.item'), function (ix, val) {
                var src = "(http://|https://|imagesmat1|imagesmat2|imagesmat3|.ctscdn.com/media/|imagesmat|//)";
                var price = _scs([val, 'td.price'], ' 01 price', ['text', 'pricecurr']);
                var qty = __sco.getvt(_scs([val, 'td.quantity select:first'], '02 qty'));
                price = (price / parseInt(qty));
                var img = __sco.attr(_scs([val, 'td.image:first img:first'], '03 image'), 'src');
                img = __sco.inbetween("media/", "", img, "fl");
                var colour = "", size = "", save = "", savelabel = "";
                if (_scs([val, 'td.savings:first'])) {
                    save = _scs([val, 'td.savings:first'], ' 05 savings', ['text']);
                }
                if (_scs([val, 'td.info:first ul.facets:first li:nth-child(1)'])) {
                    size = _scs([val, 'td.info:first ul.facets:first li:nth-child(1)'], ' 06 size', ['text']);
                    if (size.toUpperCase().indexOf('SIZE') > -1 && size.toUpperCase().indexOf('SIZE') < 4) {
                        size = size.substring(5, size.length);
                    }
                }
                colour = __sco.attr(_scs([val, 'td.info:first ul.facets:first span.swatch:first']), 'title').toUpperCase();
                if (_scs([val, 'td.savings'])) {
                    save = _scs([val, 'td.savings:first'], ' 07 savings cell', ['text']);
                ...
                __scd.b.i.push({
                    'n': _scs([val, "td.info h4:first"], "02 name", ['text']),
                    'i': _scs([val, "td.info h4:first"], "02 name", ['text']) + "-" + price + "-" + size + "-" + colour,
                    'q': parseInt(qty),
                    'u': __sco.clear(__sco.attr(_scs([val, "td.image:first img:first"], "05 image"), "src"), src, "g"),
                    'f2': '',
                    'colour': colour,
                    'size': size,
                    'save': save,
                    'savelabel': savelabel,
                    'v': price.toFixed(2),
                    "pid": _scs([val, ".details:first li:first"], "", ["text"]),
                    "link": "/product/detail/" + _scs([val, ".details:first li:first"], "", ["text"])
                });
            });
        }
        catch (be1) {
    ...
    else if (!__sco.contains(__sco.loc, 'checkout/login') && __sco.contains(__sco.loc, 'checkout/addresses')) {
        // new page will go here (addresses)
        try {
            __scd.s['shipping'] = _scs('dd.shipping:first', 'addresses shipping value', ['text', 'pricecurr']);
            var runningSubTotal = 0;

            __sco.each(_scs('.item'), function (ix, val) {
                var src = "(http://|https://|imagesmat1|imagesmat2|imagesmat3|.ctscdn.com/media/|imagesmat|//)";
                var qty = _scs([val, '.count:first'], 'item quantity (final basket)', ['text']);
                var colour = __sco.attr(_scs([val, '.swatch:first']), 'title').toUpperCase();
                var size = _scs([val, '.facets li:nth-child(1)'], 'item size (final basket)', ['text']);

                var save = '';
                var savelabel = '';
                var price = _scs([val, '.price:first'], '', ['text', 'pricecurr']);

                if (!!_scs([val, '.save'])) {
                    savelabel = "YOU SAVE:";
                    save = _scs([val, '.save:first']) != null ? __sco.inbetween('save ', '', _scs([val, '.save:first'], '', ['text']), 'fl') : '';
                }

                runningSubTotal = parseFloat(runningSubTotal) + parseFloat(price);
                __scd.b.i.push({
                    'n': _scs([val, "h3:first"], "02 name MINI", ["text"]),
                    'i': _scs([val, "h3:first"], "02 name MINI", ["text"]) + "-" + price + "-" + (size == " One Size" ? "One Size" : __sco.inbetween(" ", "", size, "ll")) + "-" + colour,
                    'q': parseInt(qty),
                    'u': __sco.clear(__sco.attr(_scs([val, "img:first"], "05 image MINI"), "src"), src, "g"),
                    'f2': '',
                    'colour': colour,
                    'size': size,
                    'save': save,
                    'savelabel': savelabel,
                    'v': (parseFloat(price) / parseInt(qty)).toFixed(2),
                    'link': __sco.getitemlink(_scs([val, "h3:first"], "02 name MINI", ["text"]))
                });
            });

            __scd.s['subtotal'] = runningSubTotal.toFixed(2);
            __scd.b.v = runningSubTotal.toFixed(2);

            __scd.s['ot'] = ((_scs('.totals:last .total:last', 'overall total', ['text', 'pricecurr'])) - parseFloat(__scd.s['shipping'])).toFixed(2);

            if (_scs('dt.promo') != null) {
                if (_scs('dt.promo').length >= 2) {
                    __scd.s.offerlabel = _scs('dt.promo:first', '', ['text']);
                    __scd.s.offervalue = _scs('dt.promo:nth-child(1)', '', ['text', 'pricecurr']);
                }
                if (_scs('dt.promo').length > 2) {
                    __scd.s.offerlabel2 = _scs('dt.promo:nth-child(2)', '', ['text']);
                    __scd.s.offervalue2 = _scs('dt.promo:nth-child(3)', '', ['text', 'pricecurr']);
                }
            }
        }
        catch (be1) {
        ...
        if (!__sco.contains(__sco.loc, '/checkout') && _scs("#minicart-items") && (_scs('body button.add-to-bag')) && !__sco.contains('/search')) {
            /*
                        try {
                            if (__sco.type(__sco.totalmonitor) == "undefined") {
                                __sco.totalmonitor = new __sco.monitor();
                                __sco.totalmonitor.compare = function () { return _scs('#minicart-items').innerHTML; }
            ...
            */
            ...
            try {
                ...
                if (_scs('#minicart dl.totals dd.promo')) {
                    __scd.s.offerlabel = _scs('#minicart dl.totals dt.promo:first', '0 promolabel MINI', ['text']);
                    __scd.s.offervalue = _scs('#minicart dl.totals dd.promo:first', '0 promo value MINI', ['text']);
                    if (_scs('#minicart dl.totals dd.promo:nth-child(1)')) {
                        __scd.s.offerlabel2 = _scs('#minicart dl.totals dt.promo:nth-child(1)', '0 promolabel 2 MINI', ['text']);
                        __scd.s.offervalue2 = _scs('#minicart dl.totals dd.promo:nth-child(1)', '0 promo value 2 MINI', ['text']);
                    }
                }

                if (_scs('#minicart dl.totals dd.shipping')) {
                    __scd.s.shippingvalue = _scs('#minicart dl.totals dd.shipping:first', ' 0 shipping MINI', ['text']);
                    shippingValue = parseFloat(_scs('#minicart dl.totals dd.shipping:first', ' 0 shipping MINI', ['text', 'pricecurr']));
                }
                if (_scs('#minicart dl.totals dd.shippingpromo')) {
                    __scd.s.shippingdiscount = _scs('#minicart dl.totals dt.shippingpromo:first', '0 shipping discount MINI', ['text']);
                    __scd.s.shippingdiscountvalue = _scs('#minicart dl.totals dd.shippingpromo:first', '0 shipping discount value MINI', ['text']);
                    shippingDiscount = parseFloat(_scs('#minicart dl.totals dd.shippingpromo:first', '0 shipping discount value MINI', ['text', 'pricecurr']));
                }
                __scd.b.v = _scs('#minicart dl.totals dd.total:first', '0 total MINI', ['text', 'pricecurr']); //Set the total value
                basketValue = parseFloat(_scs('#minicart dl.totals dd.total:last', '0 total MINI', ['text', 'pricecurr']));
                var totalDiscounts = parseFloat(__sco.pricecurr(__scd.s.offervalue2 != '' ? __sco.pricecurr(__scd.s.offervalue2) : '0.00')) + parseFloat(__sco.pricecurr(__scd.s.offervalue2 != '' ? __sco.pricecurr(__scd.s.offervalue2) : '0.00'));
                __scd.s['ot'] = (basketValue - totalDiscounts).toFixed(2);
            }
            catch (be2) {
                be2.description = "201 mini " + (be2.description || "");
                __sco.error(be2);
            }
            try {
                __sco.each(_scs('#minicart-items li.item'), function (ix, val) {
                    var src = "(http://|https://|imagesmat1|imagesmat2|imagesmat3|.ctscdn.com/media/|imagesmat|//)";
                    var colour = "", size = "", save = "", savelabel = "";
                    if (_scs([val, 'ul.facets:first span.swatch:first'])) {
                        colour = __sco.attr(_scs([val, 'ul.facets:first span.swatch:first'], '02 colour MINI'), 'title').toUpperCase();
                    }
                    if (_scs([val, 'ul.facets:first li:nth-child(1)'])) {
                        size = _scs([val, 'ul.facets:first li:nth-child(1)'], ' 03 colour MINI', ['text']);
                    }
                    if (size.toUpperCase().indexOf("SIZE") > -1 && size.toUpperCase().indexOf("SIZE") < 4) {
                        size = size.substring(5, size.length);
                    }
                    var qty = _scs([val, "span.count:first"], "04 qty MINI", ["text"]);
                    var price = _scs([val, 'li.price'], ' 05 price MINI', ['text', 'pricecurr']);
                    price = (price / parseInt(qty));
                    if (_scs([val, 'li.save'])) {
                        savelabel = "YOU SAVE";
                        save = _scs([val, 'li.save'], ' 06 savings li MINI', ['text']);
                        save = __sco.inbetween('save ', '', save, 'fl');
                    }
                    runningSubTotal = Number(runningSubTotal) + price * Number(qty);
                    // Set basket values here                    
                    __scd.b.i.push({
                        'n': _scs([val, "div.cart-item-info h3"], "02 name MINI", ["text"]),
                        'i': _scs([val, "div.cart-item-info h3"], "02 name MINI", ["text"]) + "-" + price + "-" + (size == " One Size" ? "One Size" : __sco.inbetween(" ", "", size, "ll")) + "-" + colour,
                        'q': parseInt(qty),
                        'u': __sco.clear(__sco.attr(_scs([val, "img:first"], "05 image MINI"), "src"), src, "g"),
                        'f2': '',
                        'colour': colour,
                        ...
                        'savelabel': savelabel,
                        'v': price.toFixed(2),
                        'link': __sco.getitemlink(_scs([val, "div.cart-item-info h3"], "02 name MINI", ["text"]))
                    });
                });
                __scd.s.subtotal = runningSubTotal.toFixed(2);
            }
            catch (be1) {
                be1.description = "101 mini " + (be1.description || "");
                __sco.error(be1);
            }
        }
    }
...
__sco.scraper.statusthree = function () {
    try {
        ...
        var ordern = _scs('#OrderNumber') != null ? __sco.getvt(_scs('#OrderNumber')).toString() : "";

        if (ordern == "") {
            ordern = __sco.inbetween("#", "", _scs("hgroup.left:first h3:first", "", ["text"]), "fl");
        }

        if (ordern == "" && !!dataLayer) {
            for (var key = 0; key < dataLayer.length; key++) {
                if (dataLayer.hasOwnProperty(key)) {
                    if (!!dataLayer[key].ecommerce && !!dataLayer[key].ecommerce.purchase && !!dataLayer[key].ecommerce.purchase.actionField && !!dataLayer[key].ecommerce.purchase.actionfield.id) {
                        ordern = dataLayer[key].ecommerce.purchase.actionField.id;
                    }
                }
            }
        }

        __scd.s.ordernumber = ordern;

        if (!!_scs("span.email")) {
            __scd.c.e = _scs("span.email:first", "", ["text"]);
        }
    }
    catch (s3) {
        ...
        if (__sco.management.canexec()) {
            ...
            if (__sco.support.useprovider) {
                ...
                if (__sco.management.isstatus(__sco.config.status3)) {
                    ...
                    var ordern = "";
                    if (!!_scs("#OrderNumber")) {
                        ordern = _scs('#OrderNumber') != null ? __sco.getvt(_scs('#OrderNumber')).toString() : "";
                    }

                    if (ordern == "" && !!_scs("hgroup.left:first h3")) {
                        ordern = __sco.inbetween("#", "", _scs("hgroup.left:first h3:first", "", ["text"]), "fl");
                    }
                    ...
                    timestamp.s.ordernumber = ordern;
...
try {
    ...
    __sco.osr.clientConfigModule = function () {
        meld.around(__sco.osr, "preShowChecks", function (methodCall) {
            if (__sco.contains(__sco.loc, '/store-competitions') || __sco.contains(__sco.loc, '/beanievsbobble')) { //skip checks if competition page
                __scd.s['dummyPage'] = 'true';
                __sco.management.setstatus(200);
                return true;
            }

            var result = methodCall.proceed();

            // if tests passed in normal operation, we're on a basket page
            if (result == true) {
                return result;
            }

            var pageConfig = __sco.osr.activePageConfig;
            if ((pageConfig.limitFrequency && __sco.osr.exceedsLimit) || (__sco.osr.surpressOsrOnEmailClick && __sco.osr.embSuppressed)) {
                return false;
            }

            if (__sco.osr.validPage(pageConfig) && (__scd.g.length == 0)) {
                __scd.s['dummyPage'] = 'true';
                __sco.management.setstatus(200);
                return true;
            }
        ...
        meld.around(__sco.osr, "validPage", function (methodCall) {
            if (__sco.contains(__sco.loc, '/store-competitions') || __sco.contains(__sco.loc, '/beanievsbobble')) {
                return true;
            } else {
        ...
        meld.after(__sco.osr, "continueClick", function () {
            if (this.activePageConfig.name.toLowerCase() == 'alder hey christmas charity beanie vs bobble') {
                window.setTimeout(function () {
                    document.location.href = 'http://www.matalan.co.uk/beanievsbobble?utm_source=OSRSaleCycle';
                }, 500);
            } else if (!!__sco.attr(this, 'tracking') && __sco.attr(this, 'tracking') != '') {
                var self = this;
                (function (self) {
                    window.setTimeout(function () {
                        window.location.href = __sco.attr(self, 'tracking');
                    }, 300);
                })(self);
            } else if (!!_scs('.lingerie-sc') && (__sco.contains(__sco.attr(this, 'class'), 'lingerie-sc') || __sco.contains(this.className, 'lingerie-sc'))) {
                window.setTimeout(function () {
                    document.location.href = 'http://www.matalan.co.uk/womens/brands/branded-lingerie?utm_source=OSRSaleCycle';
                }, 500);
            } else if (!!_scs('.swimwear-sc') && (__sco.contains(__sco.attr(this, 'class'), 'swimwear-sc') || __sco.contains(this.className, 'swimwear-sc'))) {
                window.setTimeout(function () {
                    document.location.href = 'http://www.matalan.co.uk/events/savings?utm_source=OSRSaleCycle';
                }, 500);
            } else if (!!_scs('.CTAB') && (__sco.contains(__sco.attr(this, 'class'), 'CTAB') || __sco.contains(this.className, 'CTAB'))) {
                window.setTimeout(function () {
                    document.location.href = 'http://www.matalan.co.uk/events/savings?utm_source=OSRSaleCycle';
                }, 500);
            } else {
                window.setTimeout(function () {
                    if (__sco.contains(__sco.loc, 'utm_source=osrsalecycle')) {
                        document.location.href = document.location.href;
                    } else {
                        var paramChar = '?';
                        if (__sco.contains(__sco.loc, '?')) {
                            paramChar = '&';
                        }
                        document.location.href = document.location.href + paramChar + 'utm_source=OSRSaleCycle';
                    }
                }, 500);
            }
        });
        ...
        meld.around(__sco.osr, "emailBasketClick", function (methodCall) {
            if (__sco.contains(__sco.loc, '/store-competitions') || __sco.contains(__sco.loc, '/beanievsbobble')) { // we don't want to affect other EMB OSRs
                if (__sco.contains(__sco.loc, '/store-competitions')) {
                    __sco.osr.activePageConfig.selectors.emailCaptureField = '#wrapper-sc .nameentry-sc.group-sc.emb-sc.email';
                } else if (__sco.contains(__sco.loc, '/beanievsbobble')) {
                    __sco.osr.activePageConfig.selectors.emailCaptureField = '#wrapper-sc .emb-sc.emailentry-sc.group-sc.email';
                }
                __sco.osr.activePageConfig.selectors.emailBasketConfirmationTemplate = '';
                var emailAddress;
                if ((emailAddress = __sco.osr.scrapeEmailAddress()) == false) { return; }

                if (__sco.contains(__sco.loc, '/store-competitions')) {
                    __scd.c.e = _scs('input.nameentry-sc.group-sc.emb-sc.email', 'Competition Email', ["getvt"]);
                } else if (__sco.contains(__sco.loc, '/beanievsbobble')) {
                    __scd.c.e = _scs('input.emailentry-sc.group-sc.emb-sc.email', 'Beanie vs Bobble Email', ["getvt"]);
                }

                if (__sco.contains(__sco.loc, '/store-competitions')) {
                    __scd.s["competition"] = true;
                } else if (__sco.contains(__sco.loc, '/beanievsbobble')) {
                    __scd.s["beanievsbobble"] = true;
                }

                __sco.addName();
                __sco.updatecustomer(__scd.c.e, "email");

                if (__sco.contains(__sco.loc, '/store-competitions')) {
                    var linkId = __sco.osr.getLinkId(_scs('div.send-sc.emailSend-sc.group-sc:first'));
                } else if (__sco.contains(__sco.loc, '/beanievsbobble')) {
                    var linkId = __sco.osr.getLinkId(_scs('div.send-sc.group-sc:first'));
                }
