//$Rev: 36425fx2 $ jQuery, Virtual Mobile Domain, Persistent Criteria
//<![CDATA[
if(!window.mmcore){
	window.mmcore={
	domain:'matalan.co.uk',
	server:'service.maxymiser.net/cg/v5/',
	cookie_domain:'.matalan.co.uk',
	tpixel:false,
	cprefix:'mmcore.',
	inline_state:true,
...
//transport
	...
	_rt:1000,
//private
	jsver:'5.14.2',_vars:{fv:{},act:{},uat:{},ids:{}},_act_id:0,_vars_alias:{act:'uv'},_renderers:{},_extensions:{},_r_mbs:{},
...
// PC
(function(){function f(a){var d=[],c,e;for(e in a)a.hasOwnProperty(e)&&(c=a[e],d.push([escape(e),escape(c)].join("=")));a=d.join("&");b.SetCookie(g,a,h,!0)}var b=this,g="mm_pc",h=365,j=b._Clear;b._Clear=function(){j.apply(b,arguments);var a=b.GetPersistentCriteria(),d,c;for(c in a)a.hasOwnProperty(c)&&(d=a[c],b.SetPersCriterion(c,d))};b.SetPersistentCriterion=function(a,d){var c=b.GetPersistentCriteria();c[a]=d;f(c);b.SetPersCriterion(a,d)};b.UnsetPersistentCriterion=function(a){var d=b.GetPersistentCriteria(); if(d.hasOwnProperty(a)){delete d[a];f(d);try{delete b._vars.uat[a]}catch(c){}}};b.GetPersistentCriteria=function(){var a={};b.GetCookie(g,!0).replace(/([^&]*)=([^&]*)/g,function(b,c,e){a[unescape(c)]=unescape(e)});return a}}).call(mmcore);
...
if (/^\/+mobile(?:\/+[^\/]*)*$/i.test(location.pathname)) {  // Switch to the virtual mobile domain.
  mmcore.domain += '.mobile';
  mmcore.cprefix += 'mobile.';
}
